...
<html>
<head>
    <title>Sistem Web Data Nasabah</title>
</head>
<body>
    <h1>Selamat datang di Sistem Web Data Nasabah</h1>
    <p>Silakan login atau daftar untuk mengakses informasi akun Anda.</p>
